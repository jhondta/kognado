...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create language' do
    assert_difference('Language.count') do
      post languages_url, params: { language: { iso_code2: @language.iso_code2,
                                                iso_code3: @language.iso_code3,
                                                name: @language.name } }
    end
  ...
  test 'should update language' do
    patch language_url(@language), params: { language: { iso_code2: @language.iso_code2,
                                                         iso_code3: @language.iso_code3,
                                                         name: @language.name } }
